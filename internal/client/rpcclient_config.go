...
func (c *RpcClient) SetConfigField(ctx context.Context, id string, scope config.Scope, key string, value any) error {
	params := struct {
		ID    string       `json:"id"`
...
func (c *RpcClient) RemoveConfigField(ctx context.Context, id string, scope config.Scope, key string) error {
	params := struct {
		ID    string       `json:"id"`
		Scope config.Scope `json:"scope"`
		Key   string       `json:"key"`
...
func (c *RpcClient) UpdatePreferredModel(ctx context.Context, id string, scope config.Scope, modelType config.SelectedModelType, model config.SelectedModel) error {
	params := struct {
		ID        string                 `json:"id"`
		Scope     config.Scope           `json:"scope"`
...
func (c *RpcClient) SetCompactMode(ctx context.Context, id string, scope config.Scope, enabled bool) error {
	params := struct {
		ID      string       `json:"id"`
		Scope   config.Scope `json:"scope"`
...
func (c *RpcClient) SetProviderAPIKey(ctx context.Context, id string, scope config.Scope, providerID string, apiKey any) error {
	params := struct {
		ID         string       `json:"id"`
		Scope      config.Scope `json:"scope"`
...
func (c *RpcClient) ImportCopilot(ctx context.Context, id string) (*oauth.Token, bool, error) {
	params := struct {
		ID string `json:"id"`
	}{ID: id}
...
func (c *RpcClient) RefreshOAuthToken(ctx context.Context, id string, scope config.Scope, providerID string) error {
	params := struct {
		ID         string       `json:"id"`
		Scope      config.Scope `json:"scope"`
		ProviderID string       `json:"provider_id"`
...
func (c *RpcClient) ProjectNeedsInitialization(ctx context.Context, id string) (bool, error) {
...
func (c *RpcClient) MarkProjectInitialized(ctx context.Context, id string) error {
	params := struct {
		ID string `json:"id"`
	}{ID: id}
...
func (c *RpcClient) GetInitializePrompt(ctx context.Context, id string) (string, error) {
	params := struct {
		ID string `json:"id"`
	}{ID: id}
...
func (c *RpcClient) EnableDockerMCP(ctx context.Context, id string) error {
	params := struct {
		ID string `json:"id"`
	}{ID: id}
...
func (c *RpcClient) DisableDockerMCP(ctx context.Context, id string) error {
	params := struct {
		ID string `json:"id"`
	}{ID: id}
...
func (c *RpcClient) RefreshMCPTools(ctx context.Context, id, name string) error {
	params := struct {
		ID   string `json:"id"`
...
func (c *RpcClient) ReadMCPResource(ctx context.Context, id, name, uri string) ([]MCPResourceContents, error) {
	params := struct {
		ID   string `json:"id"`
		Name string `json:"name"`
		URI  string `json:"uri"`
...
func (c *RpcClient) GetMCPPrompt(ctx context.Context, id, clientID, promptID string, args map[string]string) (string, error) {
	params := struct {
		ID       string            `json:"id"`
