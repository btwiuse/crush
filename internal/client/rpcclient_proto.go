...
func (c *RpcClient) ListWorkspaces(ctx context.Context) ([]proto.Workspace, error) {
...
func (c *RpcClient) CreateWorkspace(ctx context.Context, ws proto.Workspace) (*proto.Workspace, error) {
...
func (c *RpcClient) GetWorkspace(ctx context.Context, id string) (*proto.Workspace, error) {
...
func (c *RpcClient) DeleteWorkspace(ctx context.Context, id string) error {
...
func (c *RpcClient) SubscribeEvents(ctx context.Context, id string) (<-chan any, error) {
	...
	go func() {
		...
		for {
			...
			case ev, ok := <-c.eventCh:
				...
				if unwrapped != nil {
					sendRpcEvent(ctx, events, unwrapped)
				}
			}
		}
	}()
...
func sendRpcEvent(ctx context.Context, evc chan any, ev any) {
	select {
	case evc <- ev:
	case <-ctx.Done():
		return
...
func (c *RpcClient) GetLSPDiagnostics(ctx context.Context, id string, lspName string) (map[protocol.DocumentURI][]protocol.Diagnostic, error) {
...
func (c *RpcClient) GetLSPs(ctx context.Context, id string) (map[string]proto.LSPClientInfo, error) {
...
func (c *RpcClient) MCPGetStates(ctx context.Context, id string) (map[string]proto.MCPClientInfo, error) {
...
func (c *RpcClient) MCPRefreshPrompts(ctx context.Context, id, name string) error {
...
func (c *RpcClient) MCPRefreshResources(ctx context.Context, id, name string) error {
...
func (c *RpcClient) GetAgentSessionQueuedPrompts(ctx context.Context, id string, sessionID string) (int, error) {
	var count int
...
func (c *RpcClient) ClearAgentSessionQueuedPrompts(ctx context.Context, id string, sessionID string) error {
...
func (c *RpcClient) GetAgentInfo(ctx context.Context, id string) (*proto.AgentInfo, error) {
...
func (c *RpcClient) UpdateAgent(ctx context.Context, id string) error {
...
func (c *RpcClient) SendMessage(ctx context.Context, id string, sessionID, prompt string, attachments ...message.Attachment) error {
...
func (c *RpcClient) GetAgentSessionInfo(ctx context.Context, id string, sessionID string) (*proto.AgentSession, error) {
...
func (c *RpcClient) AgentSummarizeSession(ctx context.Context, id string, sessionID string) error {
...
func (c *RpcClient) InitiateAgentProcessing(ctx context.Context, id string) error {
...
func (c *RpcClient) ListMessages(ctx context.Context, id string, sessionID string) ([]proto.Message, error) {
...
func (c *RpcClient) GetSession(ctx context.Context, id string, sessionID string) (*proto.Session, error) {
...
func (c *RpcClient) ListSessionHistoryFiles(ctx context.Context, id string, sessionID string) ([]proto.File, error) {
...
func (c *RpcClient) CreateSession(ctx context.Context, id string, title string) (*proto.Session, error) {
	var sess proto.Session
	params := struct {
		ID    string `json:"id"`
...
func (c *RpcClient) ListSessions(ctx context.Context, id string) ([]proto.Session, error) {
...
func (c *RpcClient) GrantPermission(ctx context.Context, id string, req proto.PermissionGrant) error {
	params := struct {
		ID         string               `json:"id"`
...
func (c *RpcClient) SetPermissionsSkipRequests(ctx context.Context, id string, skip bool) error {
	params := struct {
		ID   string `json:"id"`
		Skip bool   `json:"skip"`
	}{ID: id, Skip: skip}
...
func (c *RpcClient) GetPermissionsSkipRequests(ctx context.Context, id string) (bool, error) {
...
func (c *RpcClient) GetConfig(ctx context.Context, id string) (*config.Config, error) {
...
func (c *RpcClient) SaveSession(ctx context.Context, id string, sess proto.Session) (*proto.Session, error) {
	params := struct {
		ID      string       `json:"id"`
...
func (c *RpcClient) DeleteSession(ctx context.Context, id string, sessionID string) error {
...
func (c *RpcClient) ListUserMessages(ctx context.Context, id string, sessionID string) ([]proto.Message, error) {
	var msgs []proto.Message
...
func (c *RpcClient) ListAllUserMessages(ctx context.Context, id string) ([]proto.Message, error) {
	var msgs []proto.Message
...
func (c *RpcClient) CancelAgentSession(ctx context.Context, id string, sessionID string) error {
...
func (c *RpcClient) GetAgentSessionQueuedPromptsList(ctx context.Context, id string, sessionID string) ([]string, error) {
	var prompts []string
...
func (c *RpcClient) GetDefaultSmallModel(ctx context.Context, id string, providerID string) (*config.SelectedModel, error) {
	params := struct {
		ID         string `json:"id"`
...
func (c *RpcClient) FileTrackerRecordRead(ctx context.Context, id string, sessionID, path string) error {
	params := struct {
		ID        string `json:"id"`
...
func (c *RpcClient) FileTrackerLastReadTime(ctx context.Context, id string, sessionID, path string) (time.Time, error) {
	params := struct {
		ID        string `json:"id"`
		SessionID string `json:"session_id"`
		Path      string `json:"path"`
...
func (c *RpcClient) FileTrackerListReadFiles(ctx context.Context, id string, sessionID string) ([]string, error) {
	var files []string
...
func (c *RpcClient) LSPStart(ctx context.Context, id string, path string) error {
	params := struct {
		ID   string `json:"id"`
		Path string `json:"path"`
	}{ID: id, Path: path}
...
func (c *RpcClient) LSPStopAll(ctx context.Context, id string) error {
